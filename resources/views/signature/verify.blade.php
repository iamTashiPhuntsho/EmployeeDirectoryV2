<x-frontend-layout>
    <x-sidebar />
    <a href="javascript:history.back()" class='fas fa-arrow-circle-left btn' style="font-size:32px; position: fixed; background-color: Transparent; color:#26578C; margin: 2rem 2rem 2rem 0.5rem;"></a>    <div class="container">
      <section class="p-5">
                      ...
                      <form action="{{ route('get_signature_code_path') }}" method="GET">
                        <div class="p-5">
                          <div class=""style="font-size: 12pt; font-family: sans-serif; line-height: 1.2; margin-bottom: 12px; font-weight: normal; padding-top:20px;">
                            ...
                            <button class="btn text-white rounded-3 btn-primary px-5 py-2" type="submit"><i class="fas fa-signature fa-fw fa-lg"></i> Generate Signature Code</button>
                          </div>
                          </div>
